...
//			count++;
	...
	boolean sorted;
	public HybridLinkedList(boolean sorted) {
		this.sorted=sorted;
	}
	...
	public HybridLinkedList add(int value) {
		if(sorted)
			addSorted(value);
		else
			append(value);
	...
	private void addSorted(int value) {
		//TODO: add the sorting logic here
	}
	
	private HybridLinkedList append(int value) {
